...
// 		color := strings.TrimRight(split[0], " ")
// 		if split[1] == "no other bags." {
// 			continue
// 		}
// 		split = strings.Split(split[1], ",")
// 		for _, inner := range split {
// 			inner = strings.ReplaceAll(inner, " bags", "")
// 			inner = strings.ReplaceAll(inner, " bag", "")
// 			line := strings.Split(inner[1:], " ")
// 			num, err := strconv.Atoi(line[0])
// 			if err != nil {
// 				continue
// 			}
// 			bagColor := strings.Join(line[1:], " ")
// 			// rules["shiny gold"] += ....
// 			if bagColor == "shiny gold" {
// 				candidates = append(candidates, color)
// 			}
// 			rules[color] = append(rules[color], BagRule{Num: num, Color: bagColor})
// 		}
// 	}
// 	fmt.Println("===")
// 	fmt.Println(rules)
...
// 			colorsSeen[candidate] = true
// 			for color, inners := range rules {
// 				for _, inner := range inners {
// 					if inner.Color == candidate {
// 						if _, ok := colorsSeen[inner.Color]; ok {
// 							newCandidates = append(newCandidates, color)
// 						}
// 					}
// 				}
// 			}
...
// 	fmt.Println(colorsSeen)
// 	// b, _ := json.MarshalIndent(rules, "", " ")
// 	// fmt.Println(string(b))
// 	fmt.Println(len(colorsSeen))
// }
...
// var input = `wavy bronze bags contain 5 striped gold bags, 5 light tomato bags.
